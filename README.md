#### **打开labelstudio**
复制链接，到浏览器搜索
![images/1.png](https://github.com/vvvvaxs/labelstudio/blob/main/images/1.png)
注册账户(邮箱无需认证，随意即可)
![images/2.png](https://github.com/vvvvaxs/labelstudio/blob/main/images/2.png)
#### **进入项目**
在首页点击Recent Projects栏右边的View All
![images/3.png](https://github.com/vvvvaxs/labelstudio/blob/main/images/3.png)
找到相应的项目，点击进入
...
若视频异常则点击1，反之
![images/11.png](https://github.com/vvvvaxs/labelstudio/blob/main/images/11.png)

#### **如何导出数据**
在项目页面点击Export
![images/12.png](https://github.com/vvvvaxs/labelstudio/blob/main/images/12.png)
选择JSON
![images/13.png](https://github.com/vvvvaxs/labelstudio/blob/main/images/13.png)
点击下方Export导出文件
![images/14.png](https://github.com/vvvvaxs/labelstudio/blob/main/images/14.png)
